	...
	public static void main(String[] args) {
		...
		if (status == 0) { // Compute tax for single filers
			...
			if (income <= 8350)
				...
				tax = 8350 * 0.10 + (33950 - 8350) * 0.15 + (68525 - 33950) * 0.25 + (104424 - 68525) * 0.28 + (income - 104425) * 0.33;
			else
				tax = 8350 * 0.10 + (33950 - 8350) * 0.15 + (68525 - 33950) * 0.25 + (104424 - 68525) * 0.28 + (186475 - 104425) * 0.33 + (income - 186475) * 0.35;
		}
